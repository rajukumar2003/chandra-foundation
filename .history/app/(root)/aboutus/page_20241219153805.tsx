...
const faqItems = [
  { 
    question: "What inspired you to start this organization?", 
    answer: "The Chandra Foundation was born from a deep-seated desire to address the pressing needs of underprivileged communities. Our founder, Chandra Kumar, witnessed firsthand the challenges faced by children lacking access to quality education and healthcare. This personal experience ignited a passion to create an organization that could make a tangible difference in people's lives."
  },
  { 
    question: "How do donations help?", 
    answer: "Donations are the lifeblood of our organization. They directly fund our educational programs, healthcare initiatives, and community development projects. For example, a donation of $50 can provide school supplies for a child for a year, while $500 can support a mobile health clinic visit to a remote village. Every contribution, regardless of size, plays a crucial role in our mission to empower communities and transform lives."
  },
  { 
    question: "How can I get involved?", 
    answer: "There are many ways to get involved with the Chandra Foundation! You can volunteer your time and skills, participate in our fundraising events, or become a regular donor. We also welcome partnerships with organizations that share our vision. Visit our 'Get Involved' page to explore specific opportunities or contact us directly to discuss how your unique talents can contribute to our cause."
  },
  { 
    question: "What are your long-term goals?", 
    answer: "Our long-term vision is to create self-sustaining communities that are empowered through education, healthcare, and economic opportunities. We aim to expand our reach to 100 villages in the next five years, establish a scholarship program for higher education, and launch a microfinance initiative to support local entrepreneurs. Ultimately, we strive to be a catalyst for positive, lasting change in the lives of thousands of families."
  }
]
...
export default function AboutUsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50/50 to-white">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-green-800 mb-12 text-center">Connect With Us</h2>
