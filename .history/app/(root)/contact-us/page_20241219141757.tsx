...
const contactInfo = [
  {
    icon: MapPin,
    title: "Our Location",
    details: "123 Charity Lane, Compassion City, CC 12345",
    action: "Visit us",
  ...
  },
  {
    icon: Mail,
    title: "Email Address",
    details: "info@chandrafoundation.org",
    action: "Email us",
    link: "mailto:info@chandrafoundation.org",
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            ...
            support. We're here to help and appreciate your involvement in our
            mission.
          </p>
        </motion.div>
        ...
        <div className="items-start">
          ...
          >
            <h2 className="text-2xl font-semibold  max-w-1/2 text-green-800 mb-6">
              Send Us a Message
            </h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {isSubmitting ? (
                  ...
                  <a
                    href="mailto:info@chandrafoundation.org?subject=Hello%20&%20Welcome&body=Hello%20world!"
