        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="aspect-video w-full rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/search/74+d+6+VIVEKPURI,+MAYA+MARKET,+BARRA+BAIPASS,+++++KANPUR+NAGAR,+++++UTTAR+PRADESH,+++++PIN:+208027/@26.4255957,80.3038477,17z/data=!3m1!4b1?entry=ttu&g_ep=EgoyMDI1MDExNS4wIKXMDSoASAFQAw%3D%3D"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
