        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="aspect-video w-full rounded-lg overflow-hidden">
              <iframe
                src="://www.google.com/httpsmaps/embed?pb=!1m18!1m12!1m3!1d3506.2233913121413!2d77.4051603!3d28.5151483!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce626851f7009%3A0x621185133cfd1ad1!2sGeeksforGeeks!5e0!3m2!1sen!2sin!4v1585040658255!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div className="mt-4 text-gray-600">
              <p className="mb-2">
                <strong>Address:</strong> 74 d 6 VIVEKPURI, MAYA MARKET, BARRA BAIPASS, KANPUR NAGAR, UTTAR PRADESH, PIN: 208027
              </p>
              <p>
                <strong>Working Hours:</strong> Monday - Sunday: 24 * 7 
              </p>
            </div>
          </motion.div>
        </div>
