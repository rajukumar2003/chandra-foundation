        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="aspect-video w-full rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed/v1/place?q=74+D+6+Vivekpuri,+Maya+Market,+Barra+Baipass,+Kanpur+Nagar,+Uttar+Pradesh,+208027&key=YOUR_GOOGLE_MAPS_API_KEY"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
