...
const programs = [
  {
    ...
    image: "/images/annasamruddhi-food-distribution.jpg",
    targetAudience: "Girl child and Pregnant women",
    impact: [
      {
        title: "Positive impacts on children",
        items: [
          "Improved nutrition: Access to nutritious food enhances cognitive development, growth, and overall health.",
          "Increased energy: Adequate food helps children participate in educational and recreational activities.",
          "Better attendance: Food distribution can encourage school attendance and reduce absenteeism.",
          "Enhanced focus: Proper nutrition improves concentration and academic performance.",
          "Reduced stunting: Adequate nutrition mitigates stunting and promotes healthy growth.",
        ],
      },
      {
        title: "Positive impacts on pregnant women",
        items: [
          "Improved maternal health: Nutritious food supports healthy pregnancy and reduces complications.",
          "Better birth outcomes: Adequate nutrition lowers risk of low birth weight, preterm birth, and infant mortality.",
          "Enhanced fetal development: Proper nutrition supports healthy fetal growth and development.",
          "Reduced anemia: Iron-rich foods alleviate anemia, reducing fatigue and other complications.",
          "Improved mental health: Nutritious food supports mental well-being and reduces stress.",
        ],
      },
    ],
  },
