        ...
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="clinics" className="max-w-4xl mx-auto">
            ...
            <TabsContent value="education" className="mt-6">
              <Card className="p-6">
                <h3 className="text-xl font-semibold text-blue-800 mb-4">Health Education Campaigns</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-blue-600 mt-1 mr-3 shrink-0" />
                    <div>
            ...
            <TabsContent value="mental-health" className="mt-6">
              <Card className="p-6">
                <h3 className="text-xl font-semibold text-blue-800 mb-4">Mental Health Programs</h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 text-blue-600 mt-1 mr-3 shrink-0" />
                    <div>
