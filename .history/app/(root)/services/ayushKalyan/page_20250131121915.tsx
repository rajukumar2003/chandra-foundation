        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="flex justify-center gap-4">
              <Button size="lg" className="bg-green-600 hover:bg-blue-700 text-white">
                Donate Now
              </Button>
              <Button size="lg" variant="outline" className="border-green-600 text-blue-600 hover:bg-blue-50">
                Volunteer With Us
              </Button>
            </div>
          </motion.div>
