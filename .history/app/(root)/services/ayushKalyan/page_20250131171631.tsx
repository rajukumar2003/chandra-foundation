...
const programs = [
  {
    title: "Free Eye Camp",
    description:
      "India has the world's largest blind population, with an estimated 12 million blind people. However, 80% of these can be corrected or prevented, mostly resulting from uncorrected refractive errors such as nearsightedness and farsightedness, and cataracts. Eye screenings and surgery play a vital role in preventing blindness, and with limited access to eye specialists We, Chandra Foundation, go to villages and provide free eye screenings to people, supported by our partner.",
