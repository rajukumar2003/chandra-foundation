...
const programs = [
    {
      ...
      description:
        "Skill development is crucial in today's rapidly evolving landscape, empowering individuals, organizations, and nations to thrive. Nations reap economic growth, reduced unemployment, and elevated standards of living, ultimately boosting global competitiveness. Skill development bridges the gap between education and employment, addressing the pressing issue of skill mismatch. Moreover, it enables individuals to navigate emerging industries, technologies, and workforce shifts, ensuring future-readiness. By prioritizing skill development, we unlock human potential, fuel economic progress, and cultivate a resilient, adaptable workforce capable of navigating the complexities of the 21st century.",
