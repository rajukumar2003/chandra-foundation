...
const programs = [
    {
      ...
      description:
        "Skill development is crucial in today's rapidly evolving landscape, empowering individuals, organizations, and nations to thrive. Skill development bridges the gap between education and employment, addressing the pressing issue of skill mismatch. By prioritizing skill development, we unlock human potential, fuel economic progress, and cultivate a resilient, adaptable workforce capable of navigating the complexities of the 21st century.",
      image: "/images/karmavikas3.png",
