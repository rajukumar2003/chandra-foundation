...
const programs = [
    {
      ...
      description:
        "Tree planting is considered one of the most attractive, eco-friendly activities that can help the planet when done properly. Trees provide many long-term and short-term benefits. They not only enhance aesthetic appeal, but they actively remove and store carbon dioxide from the atmosphere, reduce heavy rainfall by reducing the risk of flooding, improve air quality, and reduce the urban heat island effect by reflecting sunlight and providing shade. Due to the alarmingly increasing global warming and deforestation, there is a need to plant more trees and have a greener environment. That is why our Chandra Foundation keeps planting trees at various places from time to time under Project Prakriti Samvardhan.",
