        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8">
              The "VidyaUday" project seeks to create lasting change by
              providing education, training, and empowerment to those who need
              it the most. By addressing educational gaps and skills shortages,
              this project will open doors to new opportunities for children and
              young adults in marginalized communities. We hope that through
              this initiative, we can break the cycle of poverty, uplift entire
              communities, and foster a culture of lifelong learning and
              self-reliance.
            </p>
            <Button
              size="lg"
