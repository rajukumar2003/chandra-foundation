      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[1] relative rounded-3xl overflow-hidden border border-green-200">
              <Image
          ...
          >
            ...
            {/* Our Journey */}
            <div>
              <h3 className="text-2xl font-semibold text-green-700 mb-4 flex justify-center items-center">
                Our Journey
              </h3>
              <p className="text-gray-600 text-lg leading-relaxed flex justify-center items-center">
