    ...
    <div className="bg-gradient-to-b from-green-50/50 to-white">
      <section className="container mx-auto px-4 py-16 lg:py-24">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Side: Image */}
          <div className="relative aspect-square w-full max-w-lg mx-auto lg:max-w-none rounded-2xl overflow-hidden shadow-xl">
            <Image 
          ...
          <div className="space-y-8">
            ...
            {/* Quote */}
            <blockquote className="relative pl-4 border-l-4 border-green-500 italic text-gray-700 font-medium">
              "Who would care for them if we doesn't start from with ourselves?"
              <div className="w-2 h-2 bg-gray-500 absolute -left-[5px] -top-2 rounded-full"></div>
              <div className="w-2 h-2 bg-gray-500 absolute -left-[5px] -bottom-2 rounded-full"></div>
            </blockquote>
