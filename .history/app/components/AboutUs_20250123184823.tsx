            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  comprehensive support in three critical areas: health,
                  education, and employment. We work tirelessly to bridge gaps,
                  remove barriers, and create pathways to a brighter future for
