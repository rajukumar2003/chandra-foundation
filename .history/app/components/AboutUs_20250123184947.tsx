            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  quality health care, equitable education, and sustainable
                  employment opportunities. By empowering communities, we strive
                  to break the cycle of poverty and create a brighter future
                  where everyone can thrive and realize their full potential."
                  We welcome the ideas and energy for helping the people, so
                  that with assistance of our family and with the support of our
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Our mission is to foster sustainable development by providing
                  comprehensive support in health, education, and employment. We
                  work tirelessly to bridge gaps, remove barriers, and create
