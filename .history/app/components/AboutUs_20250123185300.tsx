          ...
          <div className="space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Our mission is to promote sustainable development by providing
                  holistic support in health, education, and employment,
                  striving to remove barriers, bridge gaps, and pave the way for
