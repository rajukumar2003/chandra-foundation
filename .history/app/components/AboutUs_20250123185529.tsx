          ...
          <div className="space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  We aim to create a world with access to quality healthcare,
                  education, and employment, empowering communities to break the
                  cycle of poverty and build a brighter future.
                </p>
              </div>
