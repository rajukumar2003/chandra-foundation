...
export default function CoreValues() {
  ...
  const coreValues = [
    {
      icon: Users,
      title: translations.aboutPage.values.list[0].title,
      description: translations.aboutPage.values.list[0].content,
    },
    {
      icon: Scale,
      title: translations.aboutPage.values.list[1].title,
      description: translations.aboutPage.values.list[1].content,
    },
    {
      icon: Shield,
      title: translations.aboutPage.values.list[2].title,
      description: translations.aboutPage.values.list[2].content,
    },
    {
      icon: HandshakeIcon,
      title: translations.aboutPage.values.list[3].title,
      description: translations.aboutPage.values.list[3].content,
    },
    {
      icon: Lightbulb,
      title: translations.aboutPage.values.list[4].title,
      description: translations.aboutPage.values.list[4].content,
    },
    {
      icon: Heart,
      title: translations.aboutPage.values.list[5].title,
      description: translations.aboutPage.values.list[5].content,
    },
    {
      icon: Leaf,
      title: translations.aboutPage.values.list[6].title,
      description: translations.aboutPage.values.list[6].content,
    },
  ];
  return (
