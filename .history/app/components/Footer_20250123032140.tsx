...
const socialLinks = [
  { icon: Facebook, href: "https://www.facebook.com/chandraafoundation", label: "Facebook" },
  { icon: Instagram, href: "https://www.instagram.com/chandraafoundation", label: "Instagram" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-green-200 text-sm">
              Nurturing Dreams, Transforming Lives. Together, we can make a
              difference.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-green-200 space-y-2">
              <p>74 D 6 Vivekpuri, Maya Market, Barra Baipass, Kanpur Nagar, Uttar Pradesh, 208027</p>
              <p>Phone: (+91) 9044850387
              </p>
