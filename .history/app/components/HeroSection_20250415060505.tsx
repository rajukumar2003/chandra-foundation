...
export default function HeroSection() {
  ...
  const slides = [
    {
      image: "/images/ed.jpeg",
      title: translations.hero.education.title,
      description: translations.hero.education.desc,
      cta: translations.hero.education.support,
    },
    {
      image: "/images/foods.jpg",
      title: translations.hero.meal.title,
      description: translations.hero.meal.desc,
      cta: translations.hero.meal.sponsor,
    },
    {
      image: "/images/clothes.jpg",
      title: translations.hero.warmth.title,
      description: translations.hero.warmth.desc,
      cta: translations.hero.warmth.donate,
    },
    {
      image: "/images/poor_smiling.jpg",
      title: translations.hero.compassion.title,
      description: translations.hero.compassion.desc,
      cta: translations.hero.compassion.volunteer,
    },
  ];
