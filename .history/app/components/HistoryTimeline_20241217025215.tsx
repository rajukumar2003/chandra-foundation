...
import { Heart, FileCheck, TrendingUp, Users, Award, Sparkles } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            From humble beginnings to creating lasting change, explore the milestones that have shaped our mission.
          </p>
        </motion.div>
        ...
        <div className="relative max-w-4xl mx-auto">
              ...
              <div className={`ml-12 md:ml-0 md:w-1/2 ${
                ...
                <div className="p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow">
                  <div className="flex flex-col items-start mb-2">
                    ...
                    {/* <div className="w-12 h-0.5 bg-green-200 mx-3" /> */}
          ...
          <div className="absolute left-4 md:left-1/2 bottom-0 transform -translate-x-4 md:-translate-x-4">
            <div className="w-8 h-8 rounded-full text-center  bg-green-100 flex items-center justify-center">
