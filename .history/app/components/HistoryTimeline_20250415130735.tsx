...
export default function HistoryTimeline() {
  ...
  const timelineEvents = [
    ...
    {
      year: 2020,
      title: translations.milestone[2020],
      description: translations.milestone["2020Desc"],
      icon: FileCheck,
      // stats: "Became officially recognized",
    },
    {
      year: 2021,
      title: translations.milestone[2021],
      description: translations.milestone["2021Desc"],
      icon: TrendingUp,
      // stats: "Reached 500+ beneficiaries",
    },
    {
      year: 2022,
      title: translations.milestone[2022],
      description: translations.milestone["2022Desc"],
      icon: Users,
      // stats: "100+ active volunteers",
    },
    {
      year: 2023,
      title: translations.milestone[2023],
      description: translations.milestone["2023Desc"],
      icon: Award,
      // stats: "5 community awards",
    },
    {
      year: 2024,
      title: translations.milestone[2024],
      description: translations.milestone["2024Desc"],
      icon: Sparkles,
      // stats: "Targeting 1000+ lives",
    },
    {
      year: 2025,
      title: translations.milestone[2025],
      description: translations.milestone["2025Desc"],
      icon: Rocket,
      // stats: "Nationwide recognition",
    },
  ]
  return (
    <section className="py-24 bg-gradient-to-b from-white to-green-50/50 relative">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-4">{translations.journey.title}</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
          {translations.journey.desc}
          </p>
        </motion.div>
