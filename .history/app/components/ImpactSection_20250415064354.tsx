...
import { Clock, Users, HandHeart, Handshake, CheckCircle} from 'lucide-react'
  ...
  const stats = [
    {
      ...
      value: 5,
      suffix: '+',
      label: translations.impact.years,
      color: 'text-green-500',
    },
    {
      icon: HandHeart,
      value: 1000,
      suffix: '+',
      label: translations.impact.beneficiaries,
      color: 'text-blue-500',
    },
    {
      icon: CheckCircle,
      value: 4,
      suffix: '+',
      label: translations.impact.projects,
      color: 'text-red-500',
    },
    {
      icon: Users,
      value: 50,
      suffix: '+',
      label: translations.impact.volunteers,
      color: 'text-orange-500',
    },
    {
      icon: Handshake,
      value: 2,
      suffix: '+',
      label: translations.impact.partnerships,
      color: 'text-yellow-500',
    }
  ];
