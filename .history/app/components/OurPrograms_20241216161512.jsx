            ...
            {programs.map((program, index) => (
              ...
              >
                <div className="relative w-32 h-32 mb-6">
                  ...
                  {/* Program Image */}
                  <div className="absolute inset-2 rounded-full overflow-hidden border-2 border-green-500">
                    <Image
                      src={program.image}
                      alt={program.title}
                      fill
                  ...
                  {/* Icon Overlay */}
                  <div className="absolute inset-0 flex items-center justify-center bg-green-600/0 group-hover:bg-green-600/80 transition-colors duration-300 rounded-full">
