            ...
            {programs.map((program, index) => (
              ...
              >
                <div className="relative w-64 h-64 mb-6">
                  ...
                  {/* Icon Overlay */}
                  <div className="absolute inset-0 flex items-center justify-center bg-green-200/0 group-hover:bg-green-600/80 transition-colors duration-300 rounded-full">
