            ...
            {programs.map((program, index) => (
              ...
              >
                <div className="relative w-64 h-64 mb-6">
                  ...
                  {/* Icon Overlay */}
                  <div className="absolute inset-0 flex items-center justify-center bg-green-600/0 group-hover:bg-green-600/10 transition-colors duration-300 rounded-full">
