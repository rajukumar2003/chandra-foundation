    ...
    <section className="py-16 lg:py-24 bg-gradient-to-b from-green-50 to-white overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          {/* Connection Lines */}
          <div className="hidden lg:block absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-200px)] h-[2px] bg-green-200">
            <div className="absolute top-1/2 left-1/6 -translate-y-1/2 w-2 h-2 rounded-full bg-green-400"></div>
