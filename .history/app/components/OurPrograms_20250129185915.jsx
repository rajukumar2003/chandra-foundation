  ...
  return (
    <section className="py-16 lg:py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        {/* Main Programs Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16 max-w-7xl mx-auto mb-20">
          ...
          >
            <div className="relative w-56 h-56 mb-6 mx-auto">
              <div className="absolute inset-0 rounded-full border-4 border-green-100 group-hover:border-green-200 transition-colors duration-300"></div>
            ...
            <h3 className="text-xl font-semibold text-green-700 mb-3">Health & Care</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-green-700 mb-3">Employment</h3>
            <p className="text-gray-600 max-w-xs mx-auto">
              Creating opportunities for sustainable livelihoods through KarmaVikas.
            </p>
          </motion.div>
        </div>
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-green-700 mb-3">Environmental Sustainability</h3>
          <p className="text-gray-600 max-w-sm mx-auto">Fostering climate resilience through PrakritiSamvardhan.</p>
        </motion.div>
