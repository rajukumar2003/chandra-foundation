...
const stories = [
  {
    image: "/images/education-story.jpg",
  ...
  {
    image: "/images/community-story.jpg",
            ...
            >
              <div className="text-center space-y-4">
                ...
                <div className="relative w-48 h-48 mx-auto mb-6">
                  <div className="absolute inset-0 rounded-full border-2 border-green-200 group-hover:border-green-400 transition-colors duration-300" />
                  ...
                  {/* Category Badge */}
                  <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-green-600 text-white text-xs px-3 py-1 text-n rounded-full">
                    {story.category}
                  </div>
                </div>
