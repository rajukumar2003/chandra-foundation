...
const stories = [
  {
    ...
    description: "Meet Riya, who went from struggling with basic education to becoming a top student in her class.",
    category: "Education"
  },
  {
          ...
          {stories.map((story, index) => (
            ...
            >
              <div className="text-center space-y-4">
                ...
                <Button 
                  variant="outline" 
                  className="border-green-600 text-green-600 hover:bg-green-200 hover:text-green-600"
                >
                  Read Full Story
                </Button>
              </div>
