          ...
          <div className="space-y-16">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                This charity foundation started informally in July 2019 but
                registered in January 2020. From 2019, we tried to spend more
                time with the people/children and understand their wishes and
                aspirations in life. We are proud to himself have a dream of
                helping the needy persons.
              </p>
            </div>
